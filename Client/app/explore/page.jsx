...
const exploreItems = [
  {
    ...
    details: 'One of Ethiopia\'s most sacred pilgrimage sites, dating back centuries. The intricate carvings and historical significance make this a must-visit for cultural enthusiasts.',
  ...
  },
  {
    ...
    details: 'Also known as "Tis Issat" or "Smoking Water" by locals, this majestic waterfall is a natural marvel. The best viewing is during the rainy season from July to September.',
    image: '/placeholder.svg?height=300&width=400',
  ...
  },
  {
    ...
    details: 'A hidden gem perfect for adventurers seeking off-the-beaten-path experiences. Great for photography and swimming in the natural pools.',
    image: '/placeholder.svg?height=300&width=400',
  ...
  },
  {
    ...
    details: 'Immerse yourself in the therapeutic hot springs rich in minerals. Perfect for wellness retreats and spa treatments in a natural setting.',
    image: '/placeholder.svg?height=300&width=400',
  ...
  },
  {
    ...
    details: 'A rewarding hike for adventure seekers with breathtaking views at the summit. Guides are recommended for safety and cultural insights.',
    image: '/placeholder.svg?height=300&width=400',
  ...
  },
  {
    ...
    details: 'Explore traditional crafts, local products, and authentic Ethiopian culture. Interact with local artisans and learn about traditional practices.',
    image: '/placeholder.svg?height=300&width=400',
